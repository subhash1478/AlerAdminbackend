...
var loginRegister = {
    ...
    addEditAllergenAliasService: async (data, callback) => {
        ...
        // EDIT query
        var sqlEdit = `UPDATE alertrak.Allergen SET Allergen= '${data.Allergen}', Alias= '${data.Alias}', 
    ...
    addEditAllergenService: async (data, callback) => {
        ...
        // EDIT query
        var sqlEdit = `UPDATE alertrak.alias SET AliasName= '${data.AliasName}', Exclusion='${data.Exclusion}' 
        WHERE AliasID='${data.AliasID}'`;
        //INSERT query
        var sqlInsert = `INSERT INTO alertrak.alias (AliasName, Exclusion) 
        VALUES ("${data.AliasName}", "${data.Exclusion}")`;
